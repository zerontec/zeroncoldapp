...
const Seller = () => {
  ...
  const validateForm = () => {
    ...
    useEffect(() => {
      ...
      formInfo.codigo
        ? (errors.codigo = "")
        : (errors.codigo = "Ingrese una Codigo");
    
      formInfo.identification
        ? (errors.identification = "")
        : (errors.identification = "Ingrese un identification");
    
      formInfo.address
        ? (errors.address = "")
        : (errors.address = "Ingrese un direccion");
    
		formInfo.telf
        ? (errors.telf = "")
        : (errors.telf = "Ingrese un telefono");
